...
def main():
    ...
    # display 1 to 30, increment by 5

    for ctr in range(1, 31, 5):  # starts at 10, ends at 1 less
        print(ctr)
...
# Trace: 70....... ... 45>46(A)>45>46(l)>45>46(l)>45>46(y)>45>46(B)>45>46(a)>45>46(b)>45>46(a)>49
