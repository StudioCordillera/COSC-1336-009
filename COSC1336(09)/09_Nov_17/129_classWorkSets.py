...
def main():
    ...
    print('\tPython student list: ', setPython)
    print('\tMath student list: ', setMath)



    # Enrollment in only math
    students = setMath - setPython
    print('\tEnrollment in only Math: ', students)

    # Enrollment in only python
    students = setPython - setMath
    print('\tEnrollment in only Python: ', students)


    # Enrollment in both classes list 
    students = setPython & setMath
    print('\tEnrollment in both classes list: ', students)
    

    # Enrollment list
    students = setPython|setMath
    print('\tEnrollment list: ', students)
