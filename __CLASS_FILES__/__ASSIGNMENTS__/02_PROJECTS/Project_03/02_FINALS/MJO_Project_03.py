...
# Calculate Check Fees LOGIC Function and declares fees variables, then passes totalFees back
#  ------------------------------------------------------------------------
...
# Get User input for month and checks, get those and monthIndex back then return them
#  ------------------------------------------------------------------------
def getUserInput():
...
# Handle Shenanigans (validation and month variables delegation) Function
#  ------------------------------------------------------------------------
def shenanigans():
...
# Handle months variable declaration, stores dictionary of month keys:values, and month input validation
#  ------------------------------------------------------------------------
