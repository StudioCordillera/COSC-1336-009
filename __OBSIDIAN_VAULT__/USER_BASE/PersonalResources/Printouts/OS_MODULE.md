...
# ═══════════════════════════════════════════════════════════════════════════
os.get_terminal_size()       # None | Get terminal dimensions | Returns os.terminal_size(columns, lines)
os.get_terminal_size(fd)     # File descriptor | Get terminal size | Returns os.terminal_size(columns, lines)
os.isatty(fd)                # File descriptor | Check if terminal | Returns True/False
os.ttyname(fd)               # File descriptor (Unix) | Get terminal name | Returns string path
os.ctermid()                 # None (Unix) | Get terminal filename | Returns string path
...
os.get_exec_path()           # None | Get executable search path | Returns list of directory strings
os.get_blocking(fd)          # File descriptor | Check if FD blocking | Returns True/False
os.set_blocking(fd, blocking) # FD + bool | Set FD blocking mode | Returns None
os.get_inheritable(fd)       # File descriptor | Check if FD inheritable | Returns True/False
os.set_inheritable(fd, inheritable) # FD + bool | Set FD inheritable | Returns None
os.supports_bytes_environ    # None | Check bytes environ support | Returns True/False
