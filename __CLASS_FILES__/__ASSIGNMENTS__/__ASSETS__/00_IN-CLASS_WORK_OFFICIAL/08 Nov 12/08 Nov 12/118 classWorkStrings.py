...
def main():
    ...
    signatureName = lastName.strip(' ') + ", " + firstName.strip(' ')

    print('\tSigature Name: ', signatureName)

    initial = lastName.strip(' ')[0].upper() + firstName.strip(' ')[0].upper()

    print('\tIniitals: ', initial)

    email = lastName.strip(' ')[0].upper() + firstName.strip(' ').capitalize() + '@gmail.com'
