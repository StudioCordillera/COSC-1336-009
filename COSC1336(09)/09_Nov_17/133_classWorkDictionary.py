...
def main():
    ...
    # {Key:Value}
    information = {'Name': 'SumGuy'}

    print('\tDictionary: ', information)

    information['Age'] = 28 # Cannot find 'Age' key, then appends new key to dict
    information['City'] = 'Austin' 

    print('\tDictionary: ', information)

    information['Name'] = 'Matthew' # Finds a 'Name' key and replaces it
    ...
    try:
        ...
        print('\tName: ', information['ZipCode'])
